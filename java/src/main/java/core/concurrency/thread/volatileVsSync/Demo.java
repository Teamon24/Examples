...
import core.concurrency.thread.volatileVsSync.state.State;
import core.concurrency.thread.volatileVsSync.state.StateImpl;
import core.concurrency.thread.volatileVsSync.state.SynchronizedState;
import core.concurrency.thread.volatileVsSync.state.VolatileState;
                                               ...
                                               final int actual)
    {
        return new TableUtils.Record(
            new HashMap<>() {{
                ...
                put("Case", ClassUtils.simpleName(state));
            }}
        );
    }
