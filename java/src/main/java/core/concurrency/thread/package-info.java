 ...
 * <p> - поток - часть приложения, которая разделяет память приложения с другими потоками.
 * ---------------------------------------------------------------------------------------------------------------------
 ...
 * ---------------------------------------------------------------------------------------------------------------------
 * <p>или статус прерывания, это внутренний флаг потока, который устанавлевается когда поток прерван методом
 * thread#interrupt().
 ...
 * <p>Если поток вне выше указанных методов, тогда поток прервется без выброса исключений. Каким образом периодически проверять статус прерывания будет поток определяет он сам, и производить проверку можно
