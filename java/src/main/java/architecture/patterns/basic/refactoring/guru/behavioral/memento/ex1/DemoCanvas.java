...
class DemoCanvas extends Canvas {
    ...
    private void attachKeyboardListeners() {
        this.addKeyListener(Adapters.undoRedoAdapter(editor));
    }
    ...
    private void attachMouseListeners() {
        ...
        this.addMouseListener(Adapters.colorizer(editor, repaint));
        this.addMouseListener(Adapters.selector(editor, repaint));
        MouseAdapter dragger = Adapters.dragger(editor, repaint);
