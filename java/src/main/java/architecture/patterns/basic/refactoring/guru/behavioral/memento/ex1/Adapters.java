...
import architecture.patterns.basic.refactoring.guru.behavioral.memento.ex1.command.ColorCommand;
import architecture.patterns.basic.refactoring.guru.behavioral.memento.ex1.command.MoveCommand;
    ...
    public static MouseAdapter colorizer(final Editor editor,
        ...
        return new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                architecture.patterns.basic.refactoring.guru.behavioral.memento.ex1.shape.Shape target = editor.getShapes().getChildAt(e.getX(), e.getY());
                if (target != null) {
