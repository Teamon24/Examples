 ...
 * <p>The generated values are unique per sequence. <strong>By default, hibernate_sequence</strong> is used by Hibernate. You can also tell Hibernate to use one of your own database sequences
 */
