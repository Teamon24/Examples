 ...
 * <ul><code>
 * class Pizza {
 *     <ul><p>Pizza(int size) { ... }</p>
 *     <p>Pizza(int size, boolean cheese) { ... }</p>
 *     <p>Pizza(int size, boolean cheese, boolean pepperoni) { ... }</p>
 *     <p>// ...</p>
 *     <p>Такого монстра можно создать только в языках, имеющих механизм перегрузки методов, например, C# или Java.</ul>
 * </code></ul>
 *
 ...
 * </ul>
 */
package patterns.refactoring.guru.creational.builder;