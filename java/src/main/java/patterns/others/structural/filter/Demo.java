...
import patterns.others.structural.filter.filter.AndFilter;
import patterns.others.structural.filter.filter.Filter;
import patterns.others.structural.filter.filter.FilterFemale;
import patterns.others.structural.filter.filter.FilterJunior;
import patterns.others.structural.filter.filter.FilterMale;
import patterns.others.structural.filter.filter.FilterSenior;
import patterns.others.structural.filter.filter.OrFilter;
