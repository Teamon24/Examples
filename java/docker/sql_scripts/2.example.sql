...
CREATE INDEX "bookings.fac_id__mem_id"
    ON cd.bookings
        USING btree
        (fac_id, mem_id);

CREATE INDEX "bookings.fac_id__start_time"
    ON cd.bookings
        USING btree
        (fac_id, start_time);

CREATE INDEX "bookings.mem_id__start_time"
    ON cd.bookings
        USING btree
        (mem_id, start_time);

CREATE INDEX "bookings.start_time"
    ON cd.bookings
        USING btree
        (start_time);

CREATE INDEX "members.join_date"
    ON cd.members
        USING btree
        (join_date);

CREATE INDEX "members.recommended_by"
    ON cd.members
        USING btree
        (recommended_by);
ANALYZE;
...
INSERT INTO members (id, sur_name, first_name, address, zip_code, telephone, recommended_by, join_date)
...
INSERT INTO bookings (id, fac_id, mem_id, start_time, slots)
